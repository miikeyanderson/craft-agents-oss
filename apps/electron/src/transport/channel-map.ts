...
export const CHANNEL_MAP = {
  ...
  'browserPane.updateTheme': invoke(RPC_CHANNELS.browserPane.UPDATE_THEME),
  'browserPane.showContextMenu': invoke(RPC_CHANNELS.browserPane.SHOW_CONTEXT_MENU),
  'browserPane.attachToWindow': invoke(RPC_CHANNELS.browserPane.ATTACH_TO_WINDOW),
  'browserPane.detachFromWindow': invoke(RPC_CHANNELS.browserPane.DETACH_FROM_WINDOW),
  'browserPane.setInlineBounds': invoke(RPC_CHANNELS.browserPane.SET_INLINE_BOUNDS),
  'browserPane.setRendererOverlayActive': invoke(RPC_CHANNELS.browserPane.SET_RENDERER_OVERLAY_ACTIVE),
  'browserPane.getDisplayMode': invoke(RPC_CHANNELS.browserPane.GET_DISPLAY_MODE),
  ...
  'browserPane.onDisplayModeChanged': listener(RPC_CHANNELS.browserPane.DISPLAY_MODE_CHANGED),
