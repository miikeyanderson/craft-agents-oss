...
export const RPC_CHANNELS = {
  ...
  browserPane: {
    ...
    UPDATE_THEME: 'browser-pane:update-theme',
    SHOW_CONTEXT_MENU: 'browser-pane:show-context-menu',
    ATTACH_TO_WINDOW: 'browser-pane:attach-to-window',
    DETACH_FROM_WINDOW: 'browser-pane:detach-from-window',
    SET_INLINE_BOUNDS: 'browser-pane:set-inline-bounds',
    SET_RENDERER_OVERLAY_ACTIVE: 'browser-pane:set-renderer-overlay-active',
    GET_DISPLAY_MODE: 'browser-pane:get-display-mode',
    ...
    DISPLAY_MODE_CHANGED: 'browser-pane:display-mode-changed',
